...
public class VectorTest {
    private static final String[] colors={"redish","white","blue"};
    ...
    public VectorTest(){
        ...
        System.out.println(vector.remove("red")?"\"red\" has been removed":"red cant be removed because it is not in the list");
        printVector(vector);
//        if(vector.contains("red")){
