...
int main()
{
    int noofstates,num_sym;
    cin>>noofstates>>num_sym;
    /*
        0    |   1    |    eps
    ------------------------
   A->    BC  | A      | B
    ...
    */
    ...
    char matri[noofstates][num_sym][noofstates];
   /*for page A:
    0-> B C 0
    1-> A 0 0
    e-> B 0 0
    ...
    */
    ...
    {
           cin>>ch;
           arr[starting]=ch;// 0 = A , 1 = B , 2 = C
           arr1[ch]=starting;// A = 0 , B = 1 , C = 3
           starting++;
    }
     for(int i=0;i<noofstates;i++)
     {
     ...
     for(int i=0;i<noofstates;i++)
     {
         ...
         {
             if(matri[i][num_sym-1][j]!='0' && epsilon[i]!=to_string(matri[i][num_sym-1][j]))
             {
             epsilon[i]+=matri[i][num_sym-1][j];
             }
         }
     }
